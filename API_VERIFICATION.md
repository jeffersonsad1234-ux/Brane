...
```bash
curl https://blv-dashboard-ux.preview.emergentagent.com/api/products?limit=20
```
...
```bash
curl https://blv-dashboard-ux.preview.emergentagent.com/api/desapega
```
...
```bash
curl https://blv-dashboard-ux.preview.emergentagent.com/api/stores
```
...
```bash
curl https://blv-dashboard-ux.preview.emergentagent.com/api/ads
```
