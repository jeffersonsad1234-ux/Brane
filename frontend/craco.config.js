...
// Visual edits disabled — @emergentbase/visual-edits Babel plugin
// causes "Maximum call stack size exceeded" on CodeStudio.js and other files.
// Remove this block when the upstream bug is fixed.
