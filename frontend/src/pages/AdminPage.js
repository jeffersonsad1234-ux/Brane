...
import { BarChart3, Users, ShoppingBag, CreditCard, Settings, MessageSquare, FileText, DollarSign, Check, X, Ban, Truck, Store, Megaphone, Crown, Zap, Image, Link as LinkIcon, Eye, MousePointer, Palette, Package, Trash2, Edit, Plus, Save, Sparkles } from 'lucide-react';
...
import GlobalCustomizationTab from '../components/GlobalCustomizationTab';
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <Tabs defaultValue="dashboard" className="w-full">
          <TabsList className="flex flex-wrap gap-1 bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl p-1 mb-6 h-auto">
            ...
            <TabsTrigger value="global" className="data-[state=active]:bg-purple-600 data-[state=active]:text-white text-[#888]" data-testid="admin-tab-global"><Sparkles className="w-4 h-4 mr-1" /> Global/Social</TabsTrigger>
            <TabsTrigger value="theme" className="data-[state=active]:bg-[#B38B36] data-[state=active]:text-white text-[#888]" data-testid="admin-tab-theme"><Palette className="w-4 h-4 mr-1" /> Market Theme</TabsTrigger>
          ...
          <TabsContent value="global"><GlobalCustomizationTab token={token} /></TabsContent>
