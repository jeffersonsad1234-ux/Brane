...
import { Plus, Trash2, Package, Image, Store } from 'lucide-react';
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <Dialog open={showAdd} onOpenChange={setShowAdd}>
          <DialogTrigger asChild>
            <Button className="gold-btn rounded-lg gap-2" data-testid="add-product-btn"><Plus className="w-4 h-4" /> Adicionar Produto</Button>
          </DialogTrigger>
