...
export default function SocialPage() {
  ...
  return (
   ...
   <div className="fixed inset-0 z-[9999] bg-black/60 backdrop-blur-sm flex items-start md:items-center justify-center pt-[1dvh] md:pt-0" style={{ animation: "braneFadeIn 0.2s ease" }}>
      <div className="w-[96vw] md:w-full md:max-w-4xl lg:max-w-5xl h-[calc(100dvh-1dvh-6px)] md:h-auto md:max-h-[85dvh] rounded-[28px] md:rounded-[24px] overflow-hidden flex flex-col brane-glass-mobile bg-[#050608]" style={{ animation: "braneSlideUp 0.35s cubic-bezier(0.22, 1, 0.36, 1)" }}>
