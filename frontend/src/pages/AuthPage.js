...
import { Eye, EyeOff, ArrowLeft, Sparkles, LifeBuoy, KeyRound } from 'lucide-react';
    ...
    >
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="brane-card p-6 md:p-7 brane-shadow-purple">
          ...
          {/* Recuperação de conta + suporte (discreto premium) */}
          <div className="mt-5 pt-4 border-t border-[#1E2230] flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-[12px]">
            <button
              type="button"
              onClick={() => { setSupportMode('recovery'); setSupportOpen(true); }}
              className="inline-flex items-center justify-center gap-1.5 text-[#A6A8B3] hover:text-[#D4A24C] transition-colors py-1.5"
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 text-[#A6A8B3] hover:text-[#D4A24C] transition-colors py-1.5"
              data-testid="talk-to-support-link"
            >
