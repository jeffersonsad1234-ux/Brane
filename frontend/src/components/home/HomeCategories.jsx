    ...
    <section className="max-w-7xl mx-auto px-4 pt-4 bg-white">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-3">
        {environments.map((cat) => {
          ...
          return (
            <button
              ...
              className={
                'group text-left relative min-h-[74px] rounded-[20px] overflow-hidden border bg-white shadow-[0_10px_22px_rgba(70,50,25,0.06)] hover:-translate-y-0.5 transition ' +
            ...
            >
              ...
              <div className="relative h-full p-3 flex flex-col justify-end text-white">
                <Icon size={20} className="mb-1 text-[#F1D28A]" />
        ...
        <button
          ...
          onClick={() => selectCategory('')}
          className={
            'group relative min-h-[74px] rounded-[20px] overflow-hidden border bg-white shadow-[0_10px_22px_rgba(70,50,25,0.06)] hover:-translate-y-0.5 transition ' +
            (!category ? 'border-[#D4A24C]' : 'border-[#D4A24C]/50')
          }
        >
          <div className="relative h-full p-3 flex flex-col items-center justify-center text-[#111318]">
            <Grid3X3 size={24} className="mb-1 text-[#111318]" />
