  ...
  useFrame((_, delta) => {
   ...
   return (
     <RigidBody
       ...
       fixedRotation
     >
       {/* Player body - detailed cyberpunk suit */}
       <group rotation={[0, 0, 0]}>
         ...
         {/* Chest armor plating */}
         <mesh>
           <boxGeometry args={[0.62, 1.02, 0.31]} />
           <meshStandardMaterial 
             color="#001122" 
             roughness={0.2} 
             metalness={0.9} 
         ...
         <mesh position={[-0.35, 0.2, 0]}>
           <cylinderGeometry args={[0.12, 0.6, 0.12, 8]} />
           <meshStandardMaterial 
             color="#003366" 
             roughness={0.3} 
             metalness={0.7} 
         ...
         <mesh position={[-0.18, -0.5, 0]}>
           <cylinderGeometry args={[0.16, 0.7, 0.16, 8]} />
           <meshStandardMaterial 
             color="#002244" 
             roughness={0.3} 
             metalness={0.6} 
         ...
         <mesh position={[0, 0.1, -0.22]}>
           <cylinderGeometry args={[0.22, 0.2, 0.22, 8]} />
           <meshStandardMaterial 
             color="#ff2200" 
             emissive="#ff2200" 
             emissiveIntensity={2}
